...
public class ToAssembly 
{
	...
	public String processStaticAssignment(Assignment a)
	...
	public String processFunctionCall(Functioncall f)
	{
		...
		if(f.getFunction().getName()=="__ASM__")
		{
			return makeInlineAssembly((Character)f.getParameters()[0]);
		}
	...
	/**
	 * @param name_to has to be a registername, like "r0"
	 * */
