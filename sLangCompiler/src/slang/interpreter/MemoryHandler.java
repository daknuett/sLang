...
public class MemoryHandler
{
	...
	public int getAddress(String name) throws RamFullException
	{
		int result;
	...
	int registerName(String name) throws RamFullException
	{
		/*
		 * name not yet registered. using block wise handling
		 */
